...
auto pneu::graphics::RenderObject::changeShaders() -> void {
    fCurrentShaderIndex++;
...
auto pneu::graphics::RenderObject::setShaderLight(const pneu::graphics::Light& light) -> void {
    // TODO: shader light
}

auto pneu::graphics::RenderObject::getCurrentTexture() const -> std::shared_ptr<Texture> {
    return fTextures.size() > 0 ? fTextures.at(fCurrentShaderIndex)
                                                            : nullptr;
}

auto pneu::graphics::RenderObject::addTexture(const std::string& tex_file) -> pneu::core::MethodResult {
...
auto pneu::graphics::RenderObject::getCurrentShader() const -> std::shared_ptr<pneu::graphics::Shader> {
    return fShaders.size() > 0 ? fShaders.at(fCurrentShaderIndex)
                                                         : nullptr;
}

auto pneu::graphics::RenderObject::addShader(std::shared_ptr<pneu::graphics::Shader> shader)
    -> pneu::core::MethodResult
{
    if (shader != nullptr) {
...
auto pneu::graphics::RenderObject::getModelMatrix() const -> glm::mat4 {
    return fModelMatrix;
}

auto pneu::graphics::RenderObject::setModelMatrix(const glm::mat4& matrix) -> void {
    fModelMatrix = matrix;
}

auto pneu::graphics::RenderObject::bindCurrentShader() -> void {
...
auto pneu::graphics::RenderObject::bindCurrentTexture() -> void {
...
auto pneu::graphics::RenderObject::unBindCurrentShader() -> void {
    if (getCurrentShader() != nullptr) {
        getCurrentShader()->unbind();
    }
}

auto pneu::graphics::RenderObject::unBindCurrentTexture() -> void {
    const auto k_curr_tex = getCurrentTexture();
