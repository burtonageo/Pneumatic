...
struct Renderer::RendererImpl final {
public:
  RendererImpl(int w,
               int h)
    :
...
bool Pneumatic::Graphics::Renderer::sGlewInitialized = false;

Pneumatic::Graphics::Renderer::Renderer()
  :
  fRenImpl(make_unique<Pneumatic::Graphics::Renderer::RendererImpl>(0, 0))
{

}

Pneumatic::Graphics::Renderer::~Renderer() = default;

auto
Pneumatic::Graphics::Renderer::init(GLFWwindow* win_ptr) -> bool
{
...
auto
Pneumatic::Graphics::Renderer::addRenderObject(std::weak_ptr<RenderObject> object) -> void
{
...
auto
Pneumatic::Graphics::Renderer::_updateShaderMatrices(GLuint program,
...
auto
Pneumatic::Graphics::Renderer::updateScene(double ms) -> void
{
...
auto
Pneumatic::Graphics::Renderer::renderScene() -> void
{
...
auto
Pneumatic::Graphics::Renderer::viewportDidResize(int width, int height) -> void
{
...
auto
Pneumatic::Graphics::Renderer::keyWasPressed(int key,
                                             int scanCode,
                                             int action,
                                             int mods) -> void
{
...
auto
Pneumatic::Graphics::Renderer::quitWasRequested() -> bool
{
  return false;
}
