...
auto pneu::graphics::Shader::loadFromFile(const std::string& vert_file,
...
auto pneu::graphics::Shader::initWithCode(const std::string& vert_source,
...
auto pneu::graphics::Shader::bind() -> void {
...
auto pneu::graphics::Shader::unbind() -> void {
    if (fBound) {
        glUseProgram(0);
        fBound = false;
    }
...
auto pneu::graphics::Shader::_setDefaultAttributes() -> void {
...
auto pneu::graphics::Shader::_compileShader(ShaderId shader_id, const std::string& shader_src) -> pneu::core::MethodResult {
...
auto pneu::graphics::Shader::_linkShaderProgram() -> pneu::core::MethodResult {
